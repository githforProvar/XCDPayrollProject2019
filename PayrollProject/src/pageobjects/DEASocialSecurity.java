...
@Page( title="DEA Social Security"                                
     , summary=""
     , relativeUrl=""
     , connection="Admin"
     )             
public class DEASocialSecurity {
	...
	public static class Frame1
	{
		...
		@LinkType()
		@FindBy(linkText = "DO NOT TOUCH AUTOMATION EMP 118")
		public WebElement dONOTTOUCHAUTOMATIONEMP118;
