...
public class Payroll_Regress_NIMonthlyChange_RTIReport {
	...
	public static class DoNotTouchPayrollReport
	 {
		...
		@FindBy(xpath = ".//td[2]")
		public WebElement EmployeeContributionsPayable;
		
		@FindBy(xpath = ".//td[3]")
		public WebElement EmployeeContributionsPayable1;
		
		@FindBy(xpath = ".//td[4]")
		public WebElement EmployeeContributionsPayable2;
